...
categories: 
- News
og-img: https://res.cloudinary.com/kyte/image/upload/web/post/unsplash/og_cover.jpg
img: https://res.cloudinary.com/kyte/image/upload/web/post/unsplash/cover.jpg
img-author: https://res.cloudinary.com/kyte/image/upload/web/post/author/team_design.jpg
---
...
<div class="column-box">
    <img class="column-image" src="{{site.cloudinary}}/web/post/unsplash/unsplash-1.jpg" alt="unsplash">
    <img class="column-image border" src="{{site.cloudinary}}/web/post/unsplash/unsplash-2.jpg" alt="unsplash 메일 이미지">
</div>
...
<div class="column-box">
    <img class="column-image" src="{{site.cloudinary}}/web/post/unsplash/unsplash-3.jpg" alt="스퀘어랩 여행 티셔츠 레아님 - 아이슬란드">
    <img class="column-image" src="{{site.cloudinary}}/web/post/unsplash/unsplash-4.jpg" alt="스퀘어랩 여행 티셔츠 샐리님 - 리스본">
</div>
    ...
    <hr>
        <div class="photos-info">
            <div class="photos-author">
                <img class="img-author-2" src="{{site.cloudinary}}/web/post/author/salley.jpg"> <span>by</span>Salley
            </div>
            <h4>53,264<span>Views</span></h4><h4>214<span>Downloads</span></h4>
        </div>
    <img src="{{site.cloudinary}}/web/post/unsplash/unsplash-5.jpg" alt="salley Lagos, Portugal">
</div>
<div class="photos">
    ...
    <hr>
        <div class="photos-info">
            <div class="photos-author">
                <img class="img-author-2" src="{{site.cloudinary}}/web/post/author/lea.jpg"> <span>by</span>Lea
            </div>
            <h4>39,375<span>Views</span></h4><h4>391<span>Downloads</span></h4>
        </div>
    <img src="{{site.cloudinary}}/web/post/unsplash/unsplash-6.jpg" alt="lea Reykjavik, Iceland">
</div>
<div class="photos">
    ...
    <img src="{{site.cloudinary}}/web/post/unsplash/unsplash-7.jpg" alt="salley Porto, Portugal">
</div>
<div class="photos">
    ...
    <hr>
        <div class="photos-info">
            <div class="photos-author">
                <img class="img-author-2" src="{{site.cloudinary}}/web/post/author/summer.jpg"> <span>by</span>Summer
            </div>
            <h4>18,365<span>Views</span></h4><h4>48<span>Downloads</span></h4>
        </div>
    <img src="{{site.cloudinary}}/web/post/unsplash/unsplash-8.jpg" alt="summer Sydney, Australia">
</div>
<div class="photos">
    <h2>New York, USA 🇺🇸</h2>
    <p>뉴욕, 미국</p>
    <hr>
        <div class="photos-info">
            <div class="photos-author">
                <img class="img-author-2" src="{{site.cloudinary}}/web/post/author/blair.jpg"> <span>by</span>Blair
            </div>
            <h4>7,899<span>Views</span></h4><h4>106<span>Downloads</span></h4>
        </div>
    <img src="{{site.cloudinary}}/web/post/unsplash/unsplash-9.jpg" alt="blair NY, USA">
</div>
<div class="photos">
    <h2>Sapporo, Japan 🇯🇵</h2>
    <p>삿포로, 일본</p>
    <hr>
        <div class="photos-info">
            <div class="photos-author">
                <img class="img-author-2" src="{{site.cloudinary}}/web/post/author/jay.jpg"> <span>by</span>Jay
            </div>
            <h4>3,726<span>Views</span></h4><h4>183<span>Downloads</span></h4>
        </div>
    <img src="{{site.cloudinary}}/web/post/unsplash/unsplash-10.jpg" alt="jay Sapporo, Japan">
</div>
