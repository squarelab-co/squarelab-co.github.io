...
categories: 
- Engineering
og-img: https://squarelab.co/images/blog/how-to-make-a-slack-bot/cover.png
img: /images/blog/how-to-make-a-slack-bot/cover.png
...
![google-drive-new.png](/images/blog/how-to-make-a-slack-bot/google-drive-new.png)
...
![google-apps-script-new.png](/images/blog/how-to-make-a-slack-bot/google-apps-script-new.png)
...
![google-apps-script-deploy.png](/images/blog/how-to-make-a-slack-bot/google-apps-script-deploy.png)

---

Deploy가 완료되면 `Current web app URL`이 표시됩니다. 곧 필요할테니 미리 복사해두세요.
![google-apps-script-deployed.png](/images/blog/how-to-make-a-slack-bot/google-apps-script-deployed.png)
...
![slack-api-create-new-app.png](/images/blog/how-to-make-a-slack-bot/slack-api-create-new-app.png)
...
![slack-api-basic-information.png](/images/blog/how-to-make-a-slack-bot/slack-api-basic-information.png)
...
![slack-app-event-subscriptions.png](/images/blog/how-to-make-a-slack-bot/slack-app-event-subscriptions.png)

---

Basic Information으로 돌아와서 이번에는 Add features and functionality 섹션의 Permissions를 선택합니다.
![slack-api-basic-information2.png](/images/blog/how-to-make-a-slack-bot/slack-api-basic-information2.png)
...
![slack-api-scopes.png](/images/blog/how-to-make-a-slack-bot/slack-api-scopes.png)
...
![slack-api-install-app.png](/images/blog/how-to-make-a-slack-bot/slack-api-install-app.png)
...
![google-apps-script-update.png](/images/blog/how-to-make-a-slack-bot/google-apps-script-update.png)
...
![slack-add-app.png](/images/blog/how-to-make-a-slack-bot/slack-add-app.png)

---

자, 이제 테스트 채널에 메시지를 보내보세요. Slack Bot이 메시지를 확인하면 바로 체크 이모지를 붙여줄겁니다!
![slack-add-reaction.png](/images/blog/how-to-make-a-slack-bot/slack-add-reaction.png)
